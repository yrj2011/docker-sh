...
#docker run --name my-001-prometheus -d \
#-v /usr/local/promethues/prometheus.yml:/etc/prometheus/prometheus.yml \
#-v /usr/local/promethues/server/rules.yml:/etc/prometheus/rules.yml \
#docker run --name my-001-prometheus -d   -p 9090:9090  prom/prometheus:v2.7.2 --config.file=/etc/prometheus/prometheus.yml --web.enable-lifecycle \
