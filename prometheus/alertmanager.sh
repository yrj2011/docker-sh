...
docker run -e TZ="Asia/Shanghai --name my-001-prometheus-altermanager -v /usr/local/promethues/altermanager/alertmanager.yml:/etc/alertmanager/alertmanager.yml -d   -p 9093:9093  prom/alertmanager:v0.17.0
